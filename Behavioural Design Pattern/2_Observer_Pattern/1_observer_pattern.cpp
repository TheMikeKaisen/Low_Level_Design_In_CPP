...
// REMEMBER: Abstract Class -> interface
//           Concrete Class -> class which inherits interface

// IClassName is like a convention of indicating that this is an abstract class (Interface)
class ISubscriber {
public:
...
// this is the observable class. i.e. observer classes can observe observable class.
...
int main() {
    ...
    Channel* channel = new Channel("CraftedByKarthik");
